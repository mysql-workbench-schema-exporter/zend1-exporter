...
## Global Configuration
  ...
  * `filename`
    ...
    Default value: `DbTable/%schema%/%entity%.%extension%`
...
## Zend Global Configuration

  * `tablePrefix`

    Table prefix for generated class.

    Default value: `Application_Model_DbTable_`

  * `parentTable`

    Ancestor class, the class to extend for generated class.

    Default value: `Zend_Db_Table_Abstract`
